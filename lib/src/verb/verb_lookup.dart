...
class VerbLookup {
  ...
  VerbLookup._() {
    ...
    for (var present in verbRegular) {
      String past = solveVerbRegex(present, 'VBD');
      String pastParticiple = solveVerbRegex(present, 'VBN');
  ...
  static VerbLookup get instance {
    _instance ??= VerbLookup._();
    return _instance!;
  }
  ...
  String conjugate(String input, String direction) {
    return lookup(input)[_index.indexOf(direction)];
  }
}
